    ...
    <section className="py-[clamp(48px,7vw,96px)]">
      <div className="wrap grid gap-12 md:grid-cols-2">
        ...
        {!jwt ? (
          ...
          <div className="grid gap-4 border border-gold bg-velvet-deep p-6 text-sm">
          ...
          <div className="border border-gold bg-velvet-deep p-6 text-gold-pale">
            {t("loyalty", "alreadyMember")}{" "}
            <Link href="/account" className="underline hover:text-champagne">{t("nav", "account")}</Link>
          </div>
        ) : (
