...
export function Header({ lang }: { lang: Lang }) {
  const t = tr(lang);
  const links = [["/", t("nav", "home")], ["/about", t("nav", "about")], ["/collections", t("nav", "collections")], ["/layaway", t("nav", "layaway")], ["/loyalty", t("nav", "loyalty")], ["/wholesale", t("nav", "wholesale")], ["/blog", t("nav", "blog")], ["/account", t("nav", "account")]] as const;
  return (
