...
export const dict = {
  ...
  home: {
    ...
    inquiryEyebrow: { ja: "Concierge Desk", en: "Concierge Desk" }, inquiryH: { ja: "個別のご相談・ご注文", en: "Personal enquiries and orders" },
    inquiryP: { ja: "お探しの地金・サイズ・石のご要望について、東京アトリエの専任担当が丁寧にご案内いたします。銀行振込でのお支払いに対応しております。", en: "Tell us the metal, size or stone you are looking for and our Tokyo atelier team will guide you personally. Payment is by bank transfer." },
    inquiryCta: { ja: "工房へ問い合わせる", en: "Contact the workshop" },
    salonH: { ja: "東京工房・サロン (完全予約制)", en: "Tokyo workshop and salon (by appointment)" }, salonP: { ja: "対面での検品・地金確認のご予約も承っております。", en: "In-person inspection and hallmark checks by appointment." }, salonCta: { ja: "事前アポイントメント枠を確認する", en: "Check appointment availability" },
