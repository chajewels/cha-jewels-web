...
export const aboutCopy: Record<Lang, AboutCopy> = {
  ja: {
    ...
    originNote: dict.brand.originNote.ja,
    ...
    sections: [
      {
        heading: "私たちのミッション",
        body: "確かなジュエリーを、より多くの方へ。透明な商品情報と頼れるサポートを通じて、その入口を広げていきます。K18ゴールド、プラチナ、あこや真珠、鑑定書付きダイヤモンド、天然石、ハンドメイドの天然石ブレスレット、そして厳選したプレラブドジュエリー。安心してお選びいただけるものだけをお届けします。",
      },
      {
        heading: "私たちのビジョン",
        body: "日本・フィリピン・世界各国のお客様に、安心してお選びいただけるジュエリーをお届けする、信頼される国際的なジュエリーカンパニーを目指します。普段使いの一点でも、人生の節目のお品でも、大切に育てるコレクションでも、次の世代へ受け継ぐものでも、気持ちの面でも資産の面でも永く価値の続くジュエリー選びを、お手伝いしてまいります。",
      },
    ],
    closing: [
  ...
  en: {
    ...
    originNote: dict.brand.originNote.en,
    ...
    sections: [
      {
        heading: "Our Mission",
        body: "To make authentic, high-quality jewelry accessible to more people through transparent product information, flexible interest-free layaway options, and dependable customer service. We are committed to offering K18 gold, platinum, Akoya pearls, certified diamonds, natural gemstones, handmade gemstone bracelets, and carefully selected preloved jewelry that customers can purchase with confidence.",
      },
      {
        heading: "Our Vision",
        body: "To become a trusted international jewelry company, bringing jewelry customers can choose with confidence to Japan, the Philippines, and the world. We aim to help individuals and families choose jewelry with lasting personal and material value—whether for everyday wear, meaningful milestones, treasured collections, or future generations.",
      },
    ],
    closing: [
